...
function Advertise() {
  return (
    <MetaProvider>
      <Title>
        Advertise with Tech in Jos Newsletter - www.techinjos.com.ng
      </Title>
            ...
            <div class="content md:w-10/12 lg:w-9/12 2xl:w-6/12 mx-auto space-y-3">
              <div class="bg-white p-2 md:p-6">
                ...
                <div class="space-y-6 text-base">
                  ...
                  <p>
                    Ready to reach the heart of Jos' tech scene? Contact the
                    editor via WhatsApp{" "}
                    <a href="https://wa.me/23408092772909">08092772909</a> to
